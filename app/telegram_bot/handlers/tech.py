...
from app.telegram_bot.keyboards import get_tech_keyboard, get_tech_sure_keyboard, get_home_keyboard, get_close_tech_keyboard as get_sure_close_tech_keyboard, get_move_tech_keyboard as get_sure_move_tech_keyboard
