    ...
    if TechActions().is_tech_works():
        keyboard.add(
            InlineKeyboardButton(
                text="Закончить технические работы", callback_data="EndTechWorks"
            ),
            InlineKeyboardButton(
                text="Перенести технические работы", callback_data="MoveTechWorks"
            ),
        ...
        keyboard.add(
            InlineKeyboardButton(
                text="Закрыть бота на технические работы", callback_data="TechWorks"
            ),
            InlineKeyboardButton(text="🏠", callback_data="Main"),
        )
    keyboard.adjust(1)
